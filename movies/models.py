...
class Movie(models.Model):
    ...
    fees_in_usa = models.PositiveIntegerField("Збір в США", default=0, help_text="вказувати суму в доларах")
    fees_in_world = models.PositiveIntegerField("Збір в світі", default=0, help_text="вказувати суму в доларах")
...
class MovieShots(models.Model):
    ...
    movie = models.ForeignKey(Movie, verbose_name="Филім", on_delete=models.CASCADE)
...
class RatingStar(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = "Зірок рейтингу"
